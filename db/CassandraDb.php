...
//               ->withWhiteListHosts($this->ip)
            //->withDefaultConsistency(1)   //one
            //->withDefaultConsistency(4)     //quorum
            //->withDefaultConsistency(5)  //all
     ...
     */
    public function CreateKeyspace($keyspace,$class = 'SimpleStrategy',$factor = 3)
    {
     ...
     * [DropKeyspace 删除数据库]
     * @Author   shirs
     * @DateTime 2017-05-12T16::59+0800
     * @param    [string]                   $keyspace [数据库名称]
     */
