...
class bxcq
{
    ...
    public $sdkid_to_uid_url =  "http://data-service.tanwan.com/customerService/user-info/search-uid";
    public $uid_to_sdkid_url = "http://data-service.tanwan.com/customerService/user-info/search-openid";
